...
from src.report_writing import report_writing
from src.data_loader import data_slices
from src.evaluation import prec_rec_f1score
...
def Pimodel(args, fold, x_train, y_train, x_val, y_val, x_test, y_test, x_unlabel_tar, vocab_size) :
    ...
    report_writing (args, fold, args.model + '_' + 'BERT_' + args.pretrained_model, args.lr, args.batch_size, args.epochs, args.decay,
                    args.loss_weight, train_acc.numpy (), test_accuracy,
