...
def MeanTeacher(args, fold, x_train, y_train, x_val, y_val, x_test, y_test, x_unlabel_tar, vocab_size) :
    ...
    for epoch in range(1, args.epochs + 1) :
        ...
        for step, (inputs, attention,  y_batch_train) in enumerate ( train_dataset ) :
            ...
            progbar.update ( step, values=[('Accuracy', train_acc), ('Loss', overall_cost)])
    ...
    report_writing ( args,  train_acc.numpy (), test_accuracy,
                     precision_true, precision_fake, recall_true, recall_fake, f1score_true, f1score_fake,f1_macro,f1_micro,f1_weighted, AUC )
