...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_model', type=str, choices=['distilbert-base-uncased', 'bert-base-uncased'], default='distilbert-base-uncased')
    ...
    parser.add_argument('--unlabel_ratio', type=int, default=0.5 )
